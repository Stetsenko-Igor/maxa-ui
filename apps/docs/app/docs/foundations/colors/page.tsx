...
const NEUTRAL_USAGE: Record<string, { light: string[]; dark: string[] }> = {
  ...
  "--color-neutral-100":  { light: ["border/tertiary", "bg/muted", "bg/disabled", "bg/neutral-subtle"], dark: [] },
  ...
  "--color-neutral-500":  { light: ["text/disabled", "action/neutral-active"], dark: ["text/tertiary", "border/neutral-strong"] },
  "--color-neutral-600":  { light: ["text/tertiary"], dark: ["action/neutral-active"] },
  "--color-neutral-700":  { light: [], dark: ["border/primary", "text/disabled", "bg/neutral-on-muted"] },
  "--color-neutral-800":  { light: ["text/secondary", "bg/neutral-strong"], dark: ["border/secondary", "bg/float", "bg/neutral-muted"] },
  "--color-neutral-900":  { light: [], dark: ["bg/surface", "border/tertiary", "bg/neutral-subtle"] },
