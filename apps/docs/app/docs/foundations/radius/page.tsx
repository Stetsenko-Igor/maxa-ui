...
const SCALE = [
  ...
  { name: "md", token: "--radius-md", px: 8, usage: "Dropdowns; square Avatar alias" },
  ...
  { name: "full", token: "--radius-full", px: 9999, usage: "Pills; rounded Avatar alias; loaders" },
]
...
export default function RadiusPage() {
  return (
    <DocsPageLayout
      ...
      lead={
        <>
          11-step border radius scale. Buttons and inputs use <code>xs</code>. Cards and modals use{" "}
          <code>2xl</code>.
        </>
      }
    >
