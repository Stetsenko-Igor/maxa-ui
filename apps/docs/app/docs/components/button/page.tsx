...
const BUTTON_PROPS = [
  ...
  },
  {
    ...
    type: "boolean",
    default: "false",
    description: "Square layout, no label. Always pair with aria-label.",
  },
  {
    name: "fullWidth",
    type: "boolean",
  ...
  },
  {
    ...
    type: "boolean",
    default: "false",
    description: "Adds the semantic surface fill to the outline variant. Other variants ignore it.",
  },
  {
    name: "loading",
    type: "boolean",
    default: "false",
    description: "Shows a leading spinner at full opacity and disables interaction.",
  },
  {
    name: "asChild",
    type: "boolean",
    default: "false",
    description: "Merges props onto the child element (Radix Slot).",
  },
...
const ICON_BUTTON_PROPS = [
  {
    ...
    type: "ReactNode",
    default: undefined,
    description: "Required. Icon to display.",
  },
  {
    name: "aria-label",
    type: "string",
  ...
  { name: "size", type: "'xs' | 'sm' | 'md' | 'lg'", default: "'md'", description: "Square size." },
  {
    ...
    type: "boolean",
    default: "false",
    description: "Shows a centered spinner at full opacity and disables interaction.",
  },
  { name: "disabled", type: "boolean", default: "false", description: "Disables the button." },
]

const GITHUB_BUTTON_URL =
  "https://github.com/Stetsenko-Igor/maxa-ui/tree/main/packages/ui/src/components/button"

const BUTTON_MARKDOWN = `# Button

Actions, navigation, and form submission. Eight variants, four sizes, icon support, full-width layout, and a dedicated IconButton wrapper for icon-only use cases.
...
export default function ButtonPage() {
  return (
    <ComponentPage
      ...
      lead={
        <>
          Actions, navigation, and form submission. Eight variants, four sizes, icon support, and a
          dedicated <code>IconButton</code> wrapper for icon-only use cases.
        </>
      }
    >
      {/* Preview */}
...
<Button variant="destructive">Delete</Button>`}
      ...
      <DocsSection
        ...
        description={
          <>
            Use <code>fullWidth</code> for form footers, stacked mobile actions, and single-column
            flows.
          </>
        }
      >
...
<Button size="lg">Large</Button>`}
      ...
      <DocsSection
        ...
        description={
          <>
            Pass any React node to <code>iconLeading</code> or <code>iconTrailing</code>. Symmetric
            outer padding and the label&apos;s optical padding keep the button balanced as either
      ...
      >
        <DocsExample title="Leading icon">
          <ComponentPreview
            code={`<Button variant="primary" iconLeading={<PlusIcon />}>New item</Button>
...
<Button variant="ghost" iconLeading={<DownloadIcon />}>Download</Button>`}
          >
            ...
            <Button variant="secondary" iconLeading={<DownloadIcon />}>
              Export
            </Button>
            <Button variant="ghost" iconLeading={<DownloadIcon />}>
              Download
            </Button>
          </ComponentPreview>
        </DocsExample>
        ...
        <DocsExample title="Trailing icon">
          <ComponentPreview
            code={`<Button variant="primary" iconTrailing={<ArrowRightIcon />}>Continue</Button>
<Button variant="outline" iconTrailing={<ArrowRightIcon />}>Next step</Button>`}
          >
            <Button variant="primary" iconTrailing={<ArrowRightIcon />}>
              Continue
            </Button>
            <Button variant="outline" iconTrailing={<ArrowRightIcon />}>
              Next step
            </Button>
          </ComponentPreview>
        </DocsExample>
      ...
      <DocsSection
        ...
        description={
          <>
            <code>IconButton</code> is a purpose-built wrapper that enforces <code>aria-label</code>{" "}
            at the type level. Use it whenever there is no visible label. You can also use{" "}
            <code>Button</code> with <code>iconOnly</code> directly.
          </>
        }
      >
...
<IconButton icon={<TrashIcon />} aria-label="Delete" variant="destructive" />`}
        ...
        <DocsExample title="Sizes">
          <ComponentPreview
            code={`<IconButton icon={<PlusIcon />} aria-label="Add" size="xs" />
...
<IconButton icon={<PlusIcon />} aria-label="Add" size="lg" />`}
        ...
        <DocsExample title="Using Button directly">
          <ComponentPreview
            code={`<Button iconOnly iconLeading={<PlusIcon />} variant="primary" aria-label="Add" />
...
<Button iconOnly iconLeading={<TrashIcon />} variant="ghost" aria-label="Delete" />`}
      ...
      <DocsSection
        id="loading"
        title="Loading"
        description="Keeps the label, shows an animated spinner at the leading edge, stays at 100% opacity, and disables hover, focus, press, and click interaction."
      >
        <ComponentPreview
...
<IconButton icon={<PlusIcon />} aria-label="Add" disabled />`}
      ...
      <DocsSection
        ...
        description={
          <>
            Renders button styles on any element via Radix <code>Slot</code>. Useful for Next.js{" "}
