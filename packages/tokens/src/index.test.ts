...
describe("figma color modes", () => {
  ...
  it("matches agreed semantic values for key tokens", () => {
    ...
    expect(lightFile.fg["fg-tertiary"]?.$value).toBe("{Colors.Neutral.600}")
    expect(lightFile.bg["bg-muted"]?.$value).toBe("{Colors.Neutral.25}")
    expect(lightFile.bg["bg-info-strong"]?.$value).toBe("{Colors.Blue.700}")
    ...
    expect(darkFile.fg["fg-tertiary"]?.$value).toBe("{Colors.Neutral.500}")
    expect(darkFile.bg["bg-muted"]?.$value).toBe("{Colors.Neutral.975}")
    expect(darkFile.bg["bg-info-strong"]?.$value).toBe("{Colors.Blue.500}")
    expect(darkFile.bg["bg-brand-solid"]?.$value).toBe("{Colors.Brand.600}")
    expect(darkFile.bg["bg-inverse"]?.$value).toBe("{Colors.Neutral.950}")
