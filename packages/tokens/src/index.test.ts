...
describe("figma import bundle", () => {
  ...
  it("includes Badge, Tag, and Utility component tokens", () => {
    ...
    expect(light?.["Utility/fg-neutral"]).toBe("{Utility/text-gray}")
    expect(light?.["Utility/fg-info"]).toBe("{Utility/text-blue}")
    expect(light?.["Utility/fg-inverse"]).toBe("{Color modes/text/text-inverse}")
