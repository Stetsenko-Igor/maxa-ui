...
- [`3cd1c5b`](https://github.com/Stetsenko-Igor/maxa-ui/commit/3cd1c5bc1c9f0913f7c8cc32226ec02ca2e05f70) Thanks [@kupa-maxa](https://github.com/kupa-maxa)! - Remove deprecated `--color-bg-elevated` alias. This token was aliasing `--color-bg-surface` with a 1-release deprecation notice. Migrate any usages to `--color-bg-surface`.
