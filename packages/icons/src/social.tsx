 ...
 * Social / brand icons.
 *
 * These are official provider brand marks with hardcoded brand colors — they
 * are NOT system icons and intentionally do not use `currentColor`. Source of
 * truth for the SocialButton component. For monochrome UI glyphs use the
 * Phosphor re-exports from the package root instead.
 *
 * viewBox is 0 0 24 24; size is controlled by the consumer via width/height
 * (default 100% to fill a CSS-sized container).
 */
...
export const AppleIcon = (props: SocialIconProps) => (
  <svg {...base(props)}>
    <path
      fill="#1B1A1A"
...
export const GoogleIcon = (props: SocialIconProps) => (
  <svg {...base(props)}>
    <path
      fill="#4285F4"
...
export const PinterestIcon = (props: SocialIconProps) => (
  <svg {...base(props)}>
...
export const RedditIcon = (props: SocialIconProps) => (
  <svg {...base(props)}>
...
export const TelegramIcon = (props: SocialIconProps) => (
  <svg {...base(props)}>
...
export const TiktokIcon = (props: SocialIconProps) => (
  <svg {...base(props)}>
    <path
      fill="#25F4EE"
