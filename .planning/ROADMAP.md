...
- EmptyState, PageHeader, FilterBar, Sidebar / Navigation, CommandMenu — deferred to Phase 4 product patterns (composition of shipped primitives, not core components — see `specs/core-gap-audit.md`)
  **Status**: ✅ Component layer complete. 40 components shipped with spec + implementation + docs + tests. Closed out 2026-06-11. Package-readiness bridge completed 2026-06-15 (curated icons, published entrypoint hardening, consumer install smoke, Vite bundler smoke, release guardrails).
  **Plans**: complete
...
- [ ] 04-02: First pattern implementation tranche
  - Recommended first tranche: DashboardToolbar, TemplateCardGrid, SidebarNavigation.
  - Add specs/docs with responsive behavior and product evidence.
...
**Goal**: Stable public API, migration guide, clean changelog, validated release flow. Do not enter release mode until Igor explicitly approves the registry target and package set.
**Depends on**: Phase 5
...
3. Changeset / release flow validated against `docs/release-policy.md` and `docs/release-workflow.md`
