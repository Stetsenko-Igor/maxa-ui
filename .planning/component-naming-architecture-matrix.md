...
| `DataTable` | Future data-grid abstraction | Column definitions, sorting state, selection state, pagination, loading/empty handling |
...
- `Table` is the primitive. Do not add object-driven row/column APIs until `DataTable`.
