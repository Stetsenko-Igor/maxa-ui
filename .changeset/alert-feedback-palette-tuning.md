...
Route Alert text aliases through `Color modes/text/text-primary` so Alert body and title text
stay on the normal readable text role while Alert action colors remain separate.
