...
const MIGRATIONS = {
  variables: {
    ...
    // 2026-08 action naming: positive/destructive for interactive intent;
    // success/error remain reserved for feedback and validation status.
    // Renames preserve Figma IDs so existing bindings survive.
    ...
    'Color modes/action/action-success': 'Color modes/action/action-positive',
    'Color modes/action/action-success-hover': 'Color modes/action/action-positive-hover',
    'Color modes/action/action-success-active': 'Color modes/action/action-positive-active',
    ...
    'Component-based/Button/content/text-on-color': 'Component-based/Button/primary/text',
    'Component-based/Button/content/fg-on-color': 'Component-based/Button/primary/fg',
    'Component-based/Button/success/bg': 'Component-based/Button/positive/bg',
    'Component-based/Button/success/bg-hover': 'Component-based/Button/positive/bg-hover',
    'Component-based/Button/success/bg-active': 'Component-based/Button/positive/bg-active',
    'Component-based/Button/success/text': 'Component-based/Button/positive/text',
    'Component-based/Button/success/fg': 'Component-based/Button/positive/fg',
    'Component-based/Button/success/border': 'Component-based/Button/positive/border',
    'Component-based/Button/success/border-hover': 'Component-based/Button/positive/border-hover',
  },
  textStyles: {},
  effectStyles: {},
};
