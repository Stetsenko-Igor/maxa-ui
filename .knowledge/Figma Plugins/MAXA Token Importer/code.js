...
const MIGRATIONS = {
  variables: {
    'Color modes/bg/secondary': 'Color modes/bg/bg-surface',
    'Color modes/bg/inset': 'Color modes/bg/bg-muted',
    'Color modes/bg/success-solid': 'Color modes/bg/bg-success-strong',
    'Color modes/bg/error-solid': 'Color modes/bg/bg-error-strong',
    'Color modes/bg/warning-solid': 'Color modes/bg/bg-warning-strong',
    'Color modes/bg/info-solid': 'Color modes/bg/bg-info-strong',
    'Color modes/bg-success-solid': 'Color modes/bg/bg-success-strong',
    'Color modes/bg-error-solid': 'Color modes/bg/bg-error-strong',
    'Color modes/bg-warning-solid': 'Color modes/bg/bg-warning-strong',
    'Color modes/bg-info-solid': 'Color modes/bg/bg-info-strong',
...
for (const [groupName, tokenNames] of Object.entries(COLOR_MODE_TOKEN_NAMES)) {
  for (const tokenName of tokenNames) {
    MIGRATIONS.variables[`Color modes/${groupName}/${tokenName}`] = `Color modes/${groupName}/${groupName}-${tokenName}`;
  }
}
