...
| `radius-md`   | 8px    | `--radius-md`   | Default buttons, inputs, dropdowns, square Avatar via component token    |
...
| `radius-full` | 9999px | `--radius-full` | Pills, rounded Avatar via component token, toggle tracks, circular icons |
...
- Rounded Avatar → `--avatar-radius` → `--radius-full`
- Square Avatar → `--avatar-radius-square` → `--radius-md`
- Consumers use the Avatar component token; they do not bind a Radius foundation token directly.
